...
<imscfConfig version="1.0" xmlns="http://common.imscf.restcomm.org/config">
	<sctpAssociationRemoteSides>
		...
		<sctpAssociationRemoteSide name="RS-CDF1">
			<remoteSystemType>SG</remoteSystemType>
			<associationType>diameter</associationType>
			<remoteIp1>10.133.128.90</remoteIp1>
			<remoteIp2>10.133.192.90</remoteIp2>
			<remotePort>3868</remotePort>
		</sctpAssociationRemoteSide>
----
...
_SCTP association remote side profile_ or in an _M3UA route_. SCTP
...
Defining _SCTP association remote side profiles_:
[source,xml]
----
<sctpAssociationRemoteSideProfiles>
	<sctpAssociationRemoteSideProfile name="CDF_SCTP">
		<sctpAssociationRemoteSideWrapper>
			<sctpAssociationRemoteSide>RS-CDF1</sctpAssociationRemoteSide>
		</sctpAssociationRemoteSideWrapper>
		<sctpAssociationRemoteSideWrapper>
			<sctpAssociationRemoteSide>RS-CDF2</sctpAssociationRemoteSide>
		</sctpAssociationRemoteSideWrapper>
...
Multiple _DIAMETER Gateway modules_ can be defined to handle DIAMETER
traffic towards the _roamingsms service_. An example _DIAMETER Gateway
module_ definition is shown below.
[source,xml]
----
<diameterGatewayModules>
	<diameterGatewayModule name="roamingSmsDiameterGwModule">
		...
		<originRealm>tsdp.sometelecom.com</originRealm>
		<originApplicationId>
			<vendorId>42215</vendorId>
			<authApplId>4</authApplId>
			<acctApplId>4</acctApplId>
		</originApplicationId>
		<destinationRealm>cdf.sometelecom.com</destinationRealm>
		<destinationApplicationId>
			<vendorId>0</vendorId>
			<authApplId>4</authApplId>
			<acctApplId>0</acctApplId>
		</destinationApplicationId>
	<sctpAssociationRemoteSideProfile>CDF_SCTP</sctpAssociationRemoteSideProfile>
	</diameterGatewayModule>
</diameterGatewayModules>
----
The most important property is _sctpAssociationRemoteSideProfile_ which
refers to an _SCTP association remote side profile_ shown in section SCTP
...
<httpApplicationServers>
	<httpApplicationServerGroup name="tsdp5b_roamingsms_all">
		<connectTimeoutMs>500</connectTimeoutMs>
		<readTimeoutMs>5500</readTimeoutMs>
		<reenableTimeMs>15000</reenableTimeMs>
		<url>http://192.168.1.112:8811/roamingsms_all_20140731/</url>
		<url>http://192.168.1.121:8212/roamingsms_all_20140731/</url>                   
...
<diameterRouting>
	<diameterRoutingEntry>
		...
		<httpApplicationServerGroup>tsdp5b_roamingsms_all</httpApplicationServerGroup>
