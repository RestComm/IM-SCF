...
/**
 * Singleton {@link SLELRouter} for storing the mapping between SCCP/TCAP dialogs and SL nodes.
 */
@ConcurrencyManagement(ConcurrencyManagementType.BEAN)
@Singleton
@DependsOn(value = "ConfigBean")
public class SLELRouterBean extends SLELRouter<SlElMappingData> {
    ...
    public String getDirectRouteNameTo(String otherNode) {
        if (!initialized)
            throw new IllegalStateException("SLELRouterBean not initialized!");
