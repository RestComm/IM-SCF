...
/**
 * Checks whether a message is an INFO request containing an RRBCSM body.
 */
public class SipRrbcsmDetector extends SipBodyContentDetector {

    public SipRrbcsmDetector() {
        super("requestReportBCSMEvent");
    }
