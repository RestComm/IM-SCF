...
/**
 * Interface for looking up Call instances.
 */
public interface CallStore {

    IMSCFCall getCallByImscfCallId(String imscfCallId);

    SIPCall getCallByAppSessionId(String appSessionId);
    ...
    void removeCall(IMSCFCall call);
