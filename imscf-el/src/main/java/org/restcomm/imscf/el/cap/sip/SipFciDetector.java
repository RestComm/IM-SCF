...
/**
 * Checks whether a message is an INFO request containing an FCI body.
 */
public class SipFciDetector extends SipBodyContentDetector {

    public SipFciDetector() {
        super("furnishChargingInformation");
    }
