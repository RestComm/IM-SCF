...
/**
 * Checks whether a message is an INFO request containing an applyCharging body.
 */
public class SipApplyChargingDetector extends SipBodyContentDetector {

    public SipApplyChargingDetector() {
        super("applyCharging");
    }
