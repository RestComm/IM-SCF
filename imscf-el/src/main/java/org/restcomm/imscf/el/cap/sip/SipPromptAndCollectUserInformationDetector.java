...
/** Detector class for detecting incoming promptAndCollect requests. */
public class SipPromptAndCollectUserInformationDetector extends SipBodyContentDetector {

    public SipPromptAndCollectUserInformationDetector() {
        super("promptAndCollect");
    }
