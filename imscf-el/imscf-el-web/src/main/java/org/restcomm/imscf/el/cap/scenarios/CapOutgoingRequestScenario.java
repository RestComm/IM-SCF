...
/**
 * Scenario primitive for outgoing CAP operations. This is the scenario interface towards the CAP module.
 */
public interface CapOutgoingRequestScenario {
     ...
     */
    void onReturnResult(CAPMessage response);

    /**
     * Called when a returnError arrives for this invoke.
     */
    void onErrorComponent(CAPErrorMessage error);
