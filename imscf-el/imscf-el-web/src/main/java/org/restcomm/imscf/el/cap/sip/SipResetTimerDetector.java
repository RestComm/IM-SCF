...
/**
 * Checks whether a message is an INFO request containing a resetTimer request.
 */
public class SipResetTimerDetector extends SipBodyContentDetector {

    public SipResetTimerDetector() {
        super("<resetTimer>");
    }
